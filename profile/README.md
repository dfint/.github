...
* [**df-steam-hook**](https://github.com/dfint/df-steam-hook) - current localization patch/hook for DF 50.04, provided there is a config for the corresponding version. We are trying to update configs as soon as possible after update of the game.
